 ...
 * generated in the org.soaplab.freeling3_tagging package. 
...
public class ObjectFactory {
    ...
    private final static QName _RunAndWaitFor_QNAME = new QName("http://soaplab.org/freeling3_tagging", "runAndWaitFor");
    private final static QName _GetResultsResponse_QNAME = new QName("http://soaplab.org/freeling3_tagging", "getResultsResponse");
    private final static QName _GetSomeResultsResponse_QNAME = new QName("http://soaplab.org/freeling3_tagging", "getSomeResultsResponse");
    private final static QName _Run_QNAME = new QName("http://soaplab.org/freeling3_tagging", "run");
    private final static QName _RunAndWaitForResponse_QNAME = new QName("http://soaplab.org/freeling3_tagging", "runAndWaitForResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.soaplab.freeling3_tagging
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/freeling3_tagging", name = "runAndWaitFor")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/freeling3_tagging", name = "getResultsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/freeling3_tagging", name = "getSomeResultsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/freeling3_tagging", name = "run")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/freeling3_tagging", name = "runAndWaitForResponse")
