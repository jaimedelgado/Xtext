 ...
 * generated in the org.soaplab.kwic package. 
...
public class ObjectFactory {
    ...
    private final static QName _RunAndWaitForResponse_QNAME = new QName("http://soaplab.org/kwic", "runAndWaitForResponse");
    private final static QName _GetSomeResultsResponse_QNAME = new QName("http://soaplab.org/kwic", "getSomeResultsResponse");
    private final static QName _Run_QNAME = new QName("http://soaplab.org/kwic", "run");
    private final static QName _GetResultsResponse_QNAME = new QName("http://soaplab.org/kwic", "getResultsResponse");
    private final static QName _RunAndWaitFor_QNAME = new QName("http://soaplab.org/kwic", "runAndWaitFor");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.soaplab.kwic
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/kwic", name = "runAndWaitForResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/kwic", name = "getSomeResultsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/kwic", name = "run")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/kwic", name = "getResultsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soaplab.org/kwic", name = "runAndWaitFor")
